...
public class DefaultCloudRenderer extends IRenderHandler {
	private static final ResourceLocation locationCloudsPng = new ResourceLocation("textures/environment/clouds.png");
	public static int cloudTickCounter = 0;

	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		Vec3 color = world.getCloudColour(partialTicks);
		
		
		renderClouds(world.provider.getCloudHeight(), color, partialTicks, world, mc);
		
		cloudTickCounter ++;
	}
	
	void renderClouds(float height, Vec3 color, float partialTicks, WorldClient world, Minecraft mc) {
